...
import { GetOneServiceOrderQuery } from "../use-cases/serviceOrder/queries/get-one-serviceOrders.query";
...
export const QueryServiceOrderHandlers = [GetAllServiceOrdersHandler, GetOneServiceOrderQuery, GetPagedServiceOrdersHandler];
